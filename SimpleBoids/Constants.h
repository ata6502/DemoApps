...
// Boid parameters
const float MAX_BOID_SPEED = 0.5f;                  // the max length of the velocity vector
const float BOID_MOVE_TO_CENTER_FACTOR = 0.01f;     // determines how to move a boid towards the center (percentage)
